...
2018/19 S2
Submission Deadline: March 29th, 2019 (Friday) 11.59 pm
...
void frontBackSplitLinkedList(LinkedList *ll, LinkedList *resultFrontList, LinkedList *resultBackList)
{
	...
	ListNode *tail1=malloc(sizeof(ListNode));
	ListNode *tail2=malloc(sizeof(ListNode));
    ...
    if (ll->head==NULL){
        ...
        while(index<= ll->size){
            ...
            else if(index==(ll->size+1)/2){
                tail1=cur;
            }
            else if( index==(ll->size+1)/2+1){
